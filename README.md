...
The platform lets users register, fund a wallet, browse market data, place buy/sell orders, track portfolio holdings, and receive notifications through a single API gateway.
...
- Internal or Razorpay-backed wallet payments
- Portfolio, order, wallet, notification, and admin services
 Users can register, fund a wallet, browse market data, place buy/sell orders, track portfolio holdings, and receive notifications — all through a single API gateway.
